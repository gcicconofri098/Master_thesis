...
sig_file = ROOT.TFile.Open("signal_for_s_b_10_bins.root", "READ")

signal = sig_file.Get("h2_2_signal")

signal.Scale(0.01053 * integrated_luminosity*2.27)

background_file = ROOT.TFile.Open("bckg_map_histo_QCD_corrected.root", "READ")

background = background_file.Get("bckg_QCD_corrected")


hist = ROOT.TH2F(
    "hist", "S / B; Value of Jet1 discriminator; Value of Jet2 discriminator", 10, 0.95, 1, 10, 0.95, 1
)
...
c1.SaveAs("/gpfs/ddn/cms/user/cicco/miniconda3/analysis/figures/s_b_10_bins_QCD_corrected_not_int.pdf")
